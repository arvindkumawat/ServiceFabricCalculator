...
namespace CalculatorWebService
{
    ...
    internal sealed class CalculatorWebService : StatelessService
    {
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            ...
            return new[] { new ServiceInstanceListener(initParams => new OwinCommunicationListener("calculator", new Startup(), initParams)) };
        }
        ...
        //        await Task.Delay(TimeSpan.FromSeconds(10), cancelServiceInstance);
        //    }
        //}
    }
}
