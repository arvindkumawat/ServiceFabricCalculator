...
namespace CalculatorHistoryService
{
    ...
    /// </summary>
    internal sealed class CalculatorHistoryService : StatefulService
    {
        /// <summary>
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            return new[] { new ServiceReplicaListener(initParams => new OwinCommunicationListener("history", new Startup(this.StateManager), initParams)) };
        }
        ...
        //    var myDictionary = await this.StateManager.GetOrAddAsync<IReliableDictionary<string, long>>("historyDictionary");
